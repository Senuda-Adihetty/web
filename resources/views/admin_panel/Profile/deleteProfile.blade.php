<header class="mb-4">
    <h2 class="h5 text-dark">{{ __('Delete Account') }}</h2>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password" id="password" class="form-control @if($errors->userDeletion->has('password')) is-invalid @endif" placeholder="{{ __('Password') }}">
