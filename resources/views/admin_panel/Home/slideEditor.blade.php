...
@section('content')
 ...
 <button type="button" class="btn btn-success" data-bs-toggle="modal"
                        data-bs-target="#slidermodal{{ $slider->id }}">
                                            ...
                                            {{--  <a href="/slideDelete/{{ $slider->id }}"
                                                ...
                                                <a href="{{ route('slider.delete', $slider->id) }}"
                                                    onclick="return confirm('Are you sure you want to delete this slide?')" class="btn btn-danger">
                                                    Delete
                                                 </a>
    ...
    <form method="POST" action="/slideIndex/{{ $slider->id }}" enctype="multipart/form-data">
    @csrf
     ...
     {{--  <input type="hidden" name="slider_id" value="{{ $slider->id }}">  --}}
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="second_headingBlack" id="second_headingBlack"
                                                        ...
                                                        @if ($slider->image_link)
                                                            <div class="mb-3">
                                                                <label class="form-label">Current Slide Photo</label><br>
