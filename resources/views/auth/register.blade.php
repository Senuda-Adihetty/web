...
<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="file" name="image" class="form-control" onchange="previewImage(event)" id="image">
        <center>
            <img id="imagePreview" src="#" alt="Image Preview"
                style="display: none; margin-top: 10px; max-width: 200px; border-radius: 10px;" class="rounded-circle shadow">
        </center>
        </div>
